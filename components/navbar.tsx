    ...
    <>
      ...
      {isMobileMenuOpen && (
        <motion.div
          ...
          className="fixed top-20 left-1/2 transform -translate-x-1/2 z-50 w-[90%] max-w-sm bg-background/95 backdrop-blur-md border border-border/50 rounded-2xl shadow-xl md:hidden"
        >
